   ...
   const backgroundStyle = {
    ...
    return (
      <SafeAreaView style={backgroundStyle,{flex:1}}>
        ...
        <Text style={[styles.sectionContainer, styles.sectionTitle]}>Tasks done</Text>
        <View style={styles.listContainer}>
          {isLoading ? <ActivityIndicator/> : (
            <FlatList scrollEnabled={true} nestedScrollEnabled={true} style={styles.flatListContainer }
              ...
              renderItem={({ item,index }) => (
                ...
                (<View style={styles.row}><Text>
                 ...
                 <View style={styles.row_cell_status}><Text><Icon name="check" size={40} color='purple'/></Text></View>
                  </View>):null }</Text>
              )}
            />
          )}
            ...
            linkTo='https://www.bbc.com/news/business-59161682'>
            </SectionNews>
            <SectionNews 
